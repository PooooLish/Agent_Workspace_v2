...
4. Run `python -B capabilities/tools/workspace.py new <task_name> --complexity <level>`.
...
9. Run `python -B capabilities/tools/workspace.py doctor <task_name>` after filling the task state.
